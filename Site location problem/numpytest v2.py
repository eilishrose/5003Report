# -*- coding: utf-8 -*-
"""
Created on Mon May 17 21:38:53 2021
...
root = tkinter.Tk()
root.wm_title("Site location problem")
...
model_menu.add_command(label="Run weighted map", command=graph) 
model_menu.add_command(label="Exit", command=root.destroy)
